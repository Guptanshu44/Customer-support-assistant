...
/* =========================================================================
   FIRESTORE: CLEANUP & PURGE HELPERS
   ========================================================================= */
...
export async function deleteCustomerByName(customerName) {
  if (!firestoreDb || !customerName) return false;
  try {
    const cleanName = String(customerName).toLowerCase().trim();
